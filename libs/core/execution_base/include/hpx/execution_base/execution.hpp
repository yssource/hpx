...
namespace hpx { namespace parallel { namespace execution {
    ...
    private:
        ...
        friend HPX_FORCEINLINE decltype(auto) tag_fallback_invoke(
            ...
            Ts&&... ts)
        {
            return hpx::functional::tag_invoke(bulk_sync_execute_t{},
                HPX_FORWARD(Executor, exec), HPX_FORWARD(F, f),
    ...
    private:
        ...
        friend HPX_FORCEINLINE decltype(auto) tag_fallback_invoke(
            ...
            Ts&&... ts)
        {
            return hpx::functional::tag_invoke(bulk_async_execute_t{},
                HPX_FORWARD(Executor, exec), HPX_FORWARD(F, f),
                hpx::util::detail::make_counting_shape(shape),
                HPX_FORWARD(Ts, ts)...);
        }
    ...
    private:
        ...
        friend HPX_FORCEINLINE decltype(auto) tag_fallback_invoke(
            ...
            Future&& predecessor, Ts&&... ts)
        {
            return hpx::functional::tag_invoke(bulk_then_execute_t{},
                HPX_FORWARD(Executor, exec), HPX_FORWARD(F, f),
                hpx::util::detail::make_counting_shape(shape),
                HPX_FORWARD(Future, predecessor), HPX_FORWARD(Ts, ts)...);
        }
